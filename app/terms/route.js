...
export function GET() {
  return new Response(
    legalPage({
      path: "/terms",
      title: "Terms of Use",
      description: "Terms for using the Burrete website, application, Quick Look extensions, and Codex plugin.",
      body: `
        <p>These terms cover the Burrete website, desktop application, Finder Quick Look extensions, and the Burrete plugin for Codex.</p>
        ...
        <p>You are responsible for having permission to access and process the molecular files, systems, and network resources supplied to Burrete or Codex. Do not use the software to bypass access controls, disclose confidential data without authorization, or perform unlawful activity.</p>
        ...
        <p>Downloads are provided through GitHub Releases. Documentation may link to third-party tools and services. Burrete does not control their availability, content, security, or terms.</p>
        ...
        <h2>Support</h2>
        <p>Public support is provided through the <a href="https://github.com/SergeiNikolenko/Burrete/issues">GitHub issue tracker</a>. Report sensitive security issues through a <a href="https://github.com/SergeiNikolenko/Burrete/security/advisories/new">private security advisory</a>.</p>
      `,
    }),

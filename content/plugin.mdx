...
The desktop recording shows ChatGPT opening PDB 1CRN in the hosted Burrete widget and interacting with the molecular camera and representation controls.

<video controls playsInline preload="metadata" style={{ width: "100%", borderRadius: 12 }}>
  <source src="/assets/burrete-chatgpt-plugin-demo.mp4" type="video/mp4" />
...
<video controls playsInline preload="metadata" style={{ width: "min(100%, 420px)", borderRadius: 12 }}>
  <source src="/assets/burrete-chatgpt-plugin-demo-iphone.mp4" type="video/mp4" />
  Your browser does not support embedded MP4 video.
</video>

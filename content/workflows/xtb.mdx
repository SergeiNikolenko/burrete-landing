...
description: Configure, run, inspect, cancel, and smoke-test local xTB calculations from the Burrete desktop workspace.
---
...
In the desktop app, open the structure inspector, expand **xTB**, then use **Settings → Check**. Burrete discovers `xtb` from common Pixi, local, Homebrew, and `PATH` locations. When Pixi is available, the app can also invoke its xTB installer.

...
description: Search, sort, select, edit, merge, and export SDF, SMILES, CSV, and TSV molecule collections in Burrete.
---
...
![Burrete showing a searchable molecule collection with structure cards, table columns, and grid controls.](/assets/grid-table-light.png)

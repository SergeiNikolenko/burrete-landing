---
title: Development
description: Build, validate, and change Burrete using the repository's focused development loops.
---
...
- [Documentation map](https://github.com/SergeiNikolenko/Burrete/blob/main/docs/README.md)
- [Contributing](https://github.com/SergeiNikolenko/Burrete/blob/main/.github/CONTRIBUTING.md)

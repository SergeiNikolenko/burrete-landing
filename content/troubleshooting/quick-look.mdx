...
description: Reset Finder Quick Look state and identify stale Burrete preview extension issues.
---
...
- The final app bundle does not contain `BurretePreview.appex`.
- The final app bundle does not contain `BurreteThumbnail.appex`.
